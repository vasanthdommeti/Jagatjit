...
export const FoodProducts = () => { 
 ...
 <div>
    <h1 className="textheadsmall">Malt</h1>
 ...
 <div>
    <h1 className="textheadsmall">Dairy</h1>
    <div className="paraone">
 ...
 <div>
    <h1 className="textheadsmall" style={{marginBottom:0}}>Smart Milk</h1>
    <div className="paraone" style={{display:'flex', alignItems:'center', marginBottom:'5%'}}>
    ...
    {/* <div><img src={milkproducts} alt="Smart milk product"/></div>  */}
 </div>
        </section>
    )
}
