    ...
    return (
        <section className="MaltbodySection">
            ...
            <div className="maltSectionDiv">
                <img src={mainImg} alt="img" className="mainimagemalt" />
            ...
            <div className="maltcontent-containerone">
                ...
                <div className="maltmilling-descriptionfive"> <img src={maltextraction} alt="Malt Extraction Process" /></div>
            </div>
            <div className="maltprocess-list">
                <ul>
                    <li>Milling</li>
                    <li>Liquefaction of grain</li>
                    <li>Mashing</li>
            ...
            <div className="maltcontent-container">
                ...
                <div className="maltmilling-descriptionlast">
                    <img src={evaporation} alt="evoparation Process" className="maltImageone" />  </div>
            </div>
        </section>
    )
}
