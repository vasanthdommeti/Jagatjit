...
export const OurProcess = () => {
   ...
   <div className="process-container">
    <h4>Our Process</h4>
    <h1 className="process-title">From Humble Grain to Liquid Gold</h1>
  ...
  <div className="process-wrapper">
    ...
    {/* <div className="process-image"> */}
        <img src={bg1} alt="distillery"  className="process-image"/>
    {/* </div>  */}
     <div className="process-description">
        <h1 className="process-title">State-of-the-Art Distillery</h1>
      <p className="pre-blending-description">State-of-the-Art Distillery JIL’s hyper-modern and efficient multi-pressure distillation plant is set up with equipment supplied by the best national and international manufacturers. The pot stills are made from thick copper plate and yield a particularly smooth and pure spirit.</p>
    </div>
  </div>

  <div className="process-wrappers">
    
    <div className="process-descriptions">
        <div className="process-titles">
      <h1>Pre-Blending & Bottling</h1></div>
      <p className="pre-blending-descriptions">At JIL we know that the storage of whisky prior to blending and bottling is crucial to produce a truly elegant whisky. For this, we have 30,000 oak wood casks, (imported from the best cooperages in Scotland) resting in our cool, dark and damp warehouses. The earthen floors in these warehouses allow nature to play its part in the making a great whisky. Our casks are made from the best naturally-aged center Ringwood, storing our premium malt spirits with love and care under perfect conditions until they are drawn by our talented and meticulous blenders and converted into fine bottled whisky.</p>
      <div className="process-images"><img src={bg2} alt="distillery"/></div> 
    </div>
  </div>

  <div className="process-wrapper">
    <div className="process-image"><img src={bg3} alt="brewing facilities"/></div> 
     <div className="process-description">
        <h1 className="process-title">Brewing Facilities</h1>
      <p className="pre-blending-description">Jagatjit has an automated state-of-the-art brewing facility based on German technology. Our equipment is supplied by the best plant and machinery suppliers in the world.</p>
    </div>
  </div>
  <div className="process-wrappers">
  <div className="process-descriptions">
    <div className="process-titles">
  <h1>High Tech Bottling Hall</h1></div>
  <p className="pre-blending-descriptions">Jagatjit has the state-of-the-art automatic bottling facilities at its bottling halls, with equipment for tunnel rinsing, hydro washing, filling, capping, and labelling. Apart from indigenous, high speed automatic bottling machines, JIL sources equipment from the world’s leading suppliers in Germany and Italy. The bottling halls are well screened, have air curtains and insect killers installed which, with modern cleaning equipment, make  certain that the bottling area has the highest level of hygiene.
  </p>
  <div className="process-images"><img src={bg4} alt="bottling"/></div> 
</div>
</div>

<div className="process-container">
  <h1 className="process-title">Plants and Units</h1>
  <p> 
