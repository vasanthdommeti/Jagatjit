...
export const OurProcess = () => {
    return ( 
        <section className='ourProcessMainDiv' style={{paddingTop:'12%'}}>
   <div className="ourProcess-process-container">
    <h4>Our Process</h4>
    <h1 className="ourProcess-process-title">From Humble Grain to Liquid Gold</h1>
  ...
  <div className="ourProcess-process-wrapper">
    ...
    <div className="ourProcess-process-image">
     ...
     <div className="ourProcess-process-description">
