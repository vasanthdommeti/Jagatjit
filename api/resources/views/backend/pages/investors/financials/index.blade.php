                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header"
                            ...
                            <a href="{{ route('financial.create')}}" class="btn btn-primary">Create New Files</a>
                        </div>
                        <div class="card-body">
