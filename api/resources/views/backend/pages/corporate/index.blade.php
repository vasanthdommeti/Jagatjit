                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title">Corporate Table</h5>
                            <a href="{{ route('corporate.create')}}" class="btn btn-primary">Add New Profile</a>
                        </div>
                        @if (session('success'))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="{{ route('corporate.destroy',[$item->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
