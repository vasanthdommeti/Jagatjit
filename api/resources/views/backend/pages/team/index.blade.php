                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header"
                            ...
                            <a href="{{ route('team.create')}}" class="btn btn-primary">Add New Profile</a>
                        </div>
                        @if (session('success'))
                            ...
                            <table id="datatable1" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($item->team_image))
                                            <button class="btn btn-secondary image-btn" data-bs-toggle="modal"
                                                data-bs-target="#imageModal" data-img-url="{{$item->team_image}}">
                                                <img src="{{$item->team_image}}" alt="Thumbnail"
