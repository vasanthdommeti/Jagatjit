                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header"
                            ...
                            <a href="{{ route('achievement.create')}}" class="btn btn-primary">Add New Achievement</a>
                        </div>
                        @if (session('success'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-secondary image-btn" data-bs-toggle="modal"
                                                data-bs-target="#imageModal" data-img-url="{{$item->achievement_image}}">
                                                <img src="{{$item->achievement_image}}" alt="Thumbnail"
