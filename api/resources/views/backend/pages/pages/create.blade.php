...
<main class="mt-5 page-content">
    ...
    <div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
        <div class="breadcrumb-title pe-3">Page Create</div>
        <div class="ps-3">
                ...
                <div class="card-body">
                    <form action="{{ route('page.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="color" class="form-control color-picker" id="bigHeaderColor" name="big_header_color" title="Choose your color">
                            </div>
                        </div>
                        ...
                        <fieldset class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="gridRadios1" value="1" checked name="is_active">
                                    <label class="form-check-label" for="gridRadios1">
                                        Active
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="gridRadios2" value="0" name="is_active">
